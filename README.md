...
## Source order
    ...
    R/lifecycle.R            # weekly cursor: advance/open/close week
    ...
    setup_campaign.R         # bootstrap: seed campaign + board + teams
...
NOT YET EXERCISED / still thin:
  ...
  - The weekly cursor lifecycle (advance/open/close week) and the campaign
    bootstrap NOW EXIST (R/lifecycle.R, setup_campaign.R). The app's Advance
    button is wired. Still unrun against a live DB.
